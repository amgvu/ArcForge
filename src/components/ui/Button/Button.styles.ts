export const buttonStyles = (disabled: boolean) => {
    const baseStyles =
      'inline-flex items-center gap-2 rounded-md py-1.5 px-3 text-sm font-medium shadow-inner shadow-white/10 focus:outline-none transition duration-150 ease-in-out';
